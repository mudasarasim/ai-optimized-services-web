...
function PlaceOrder() {
  ...
  const [serviceName] = useState("Men's Salon");
  ...
  const addonOptions = [
 { id: 1, name: 'Hair Cuting Salon', price: 45, image: image1 },
    { id: 2, name: 'Men Slon Facial', price: 65, image: image2 },
    { id: 3, name: 'Complete Look', price: 240, image: image3 },
  ];
