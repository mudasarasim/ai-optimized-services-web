        ...
        n.$form = r, n.options = s, n.$container = a(s.container, r), n.$loading = a(s.loading, r), n.$submitButton = a(s.submitButton, r), n.reset = function(t) {
            ...
            if (!i) {
                if (i = !0, n.$submitButton[o ? "prop" : "attr"]("disabled", !0), n.$loading.fadeIn("slow"), window.grecaptcha) {
                    ...
                    if (e.length && "invisible" === e.data("size")) return "v3" === e.data("version") ? void grecaptcha.execute(e.data("recaptcha-id"), {
                        action: "quform"
                    }).then(function(t) {
            ...
            r.ajaxSubmit({
                ...
                success: function(e) {
                    if (null == e) n.reset(), n.errorMessage(s.errorResponseEmpty);
...
function(o) {
    ...
    function(t) {
        ...
        return y.defaults = {
            ...
            return g && (i /= 2), m.offset = e(m.offset), m.over = e(m.over), this.each(function() {
                ...
                if (null !== t) {
                    var c, l = v(this),
                        h = l ? this.contentWindow || window : this,
                        u = r(h),
                        d = t,
                        p = {};
                    switch (typeof d) {
        ...
        z.fn.attr2 = function() {
            ...
            function s(t) {
                ...
                function e() {
                    ...
                    try {
                        if (d.extraData)
                            for (var n in d.extraData) d.extraData.hasOwnProperty(n) && (z.isPlainObject(d.extraData[n]) && d.extraData[n].hasOwnProperty("name") && d.extraData[n].hasOwnProperty("value") ? s.push(z('<input type="hidden" name="' + d.extraData[n].name + '">', c).val(d.extraData[n].value).appendTo(a)[0]) : s.push(z('<input type="hidden" name="' + n + '">', c).val(d.extraData[n]).appendTo(a)[0]));
                    ...
                    if (!g.aborted && !C) {
                        ...
                        if (q && q.location.href !== d.iframeSrc || v) {
                            ...
                            try {
                                ...
                                var o, r, a, c = (d.dataType || "").toLowerCase(),
                ...
                var i, s, d, p, o, f, m, g, n, r, v, y, a = M[0],
                    b = z.Deferred();
                if (b.abort = function(t) {
                        g.abort(t)
                    }, t)
                    for (s = 0; s < L.length; s++) i = z(L[s]), W ? i.prop("disabled", !1) : i.removeAttr("disabled");
            ...
            var c, l, L = [],
                h = this.formToArray(E.semantic, L, E.filtering);
            ...
            }), !E.dataType && E.target ? (d = E.success || function() {}, m.push(function(t, e, i) {
                var s = arguments,
            ...
            var n, o, r, a, c, l, h, u, d, p, f = this[0],
                m = this.attr("id"),
            ...
            for (z.isFunction(i) && (g = z.map(g, i)), o = 0, h = g.length; o < h; o++)
                if ((a = (l = g[o]).name) && !l.disabled)
                    if (t && f.clk && "image" === l.type) f.clk === l && (s.push({
                        name: a,
                        value: z(l).val(),
                        type: l.type
                    }), s.push({
                ...
                for (e && e.push(l), r = 0, u = c.length; r < u; r++) s.push({
                    name: a,
                    value: c[r]
                });
    ...
    function(mt, gt, vt) {
        ! function(t) {
            ...
            function p(t, e, i, s) {
                this.id = i, this.target = t, this.tooltip = w, this.elements = {
                    target: t
                }, this._id = T + "-" + i, this.timers = {
                    img: {}
            ...
            function f(t) {
                ...
                return i(t) ? A : (i(t.metadata) && (t.metadata = {
                    ...
                    text: n = s(e) ? A : e
                } : n = e.text, "ajax" in e && (o = e.ajax, r = o && o.once !== A, delete e.ajax, e.text = function(t, s) {
            ...
            function m(t) {
                if (!this.tooltip.hasClass(H) && !this.destroyed) {
                    ...
                    } catch (t) {} else this.timers.hide = a.call(this, function() {
                        this.toggle(A, t)
            ...
            function o(t, e) {
                return Math.ceil(parseFloat(function(t, e) {
                    var i, s, n = e.charAt(0).toUpperCase() + e.slice(1),
                        o = (e + " " + ft.join(n + " ") + n).split(" "),
                        r = 0;
                    if (pt[e]) return t.css(pt[e]);
                    for (; i = o[r++];)
                        if ((s = t.css(i)) !== vt) return pt[e] = i, s
                }(t, e)))
            }
            ...
            var y, b, r, x, k = !0,
                ...
                _ = "data-hasqtip",
                u = "data-qtip-id",
                j = ["ui-widget", "ui-tooltip"],
                q = "." + T,
                C = "click dblclick mousedown mouseup mousemove mouseleave mouseenter".split(" "),
                N = T + "-fixed",
                X = T + "-default",
                B = T + "-focus",
                R = T + "-hover",
                ...
                Q = {
                    ie: function() {
                        for (var t = 4, e = gt.createElement("div");
                            (e.innerHTML = "\x3c!--[if gt IE " + t + "]><i></i><![endif]--\x3e") && e.getElementsByTagName("i")[0]; t += 1);
                        return 4 < t ? t : NaN
                    }(),
            ...
            U.set = function(n, t) {
                ...
                }, f.mouse && _ && C && (w.left -= (C.scrollX || 0) - j.scrollLeft(), w.top -= (C.scrollY || 0) - j.scrollTop());
                else {
                ...
                return w.left += f.x + (h.x === W ? -g : h.x === $ ? -g / 2 : 0), w.top += f.y + (h.y === O ? -v : h.y === $ ? -v / 2 : 0), I.viewport ? (n = w.adjusted = I.viewport(this, w, c, y, b, g, v), s && n.left && (w.left += s.left), s && n.top && (w.top += s.top), n.my && (this.position.my = n.my)) : w.adjusted = {
                    ...
                    S(this).css({
                        opacity: "",
                        height: ""
                    }), Q.ie && this.style.removeAttribute("filter"), t()
                ...
                if (!e[0]) return i;
                for (var n, o, r, a, c = S(t[0].ownerDocument), l = !!Q.ie && "CSS1Compat" !== gt.compatMode, h = e[0];
                    "static" !== (o = S.css(h, "position")) && ("fixed" === o ? (r = h.getBoundingClientRect(), s(c, -1)) : ((r = S(h).position()).left += parseFloat(S.css(h, "borderLeftWidth")) || 0, r.top += parseFloat(S.css(h, "borderTopWidth")) || 0), i.left -= r.left + (parseFloat(S.css(h, "marginLeft")) || 0), i.top -= r.top + (parseFloat(S.css(h, "marginTop")) || 0), n || "hidden" === (a = S.css(h, "overflow")) || "visible" === a || (n = S(h))), h = h.offsetParent;);
            ...
            G.invert = function(t, e) {
                ...
                var o, r, a, c = t ? "show" : "hide",
                    l = this.options[c],
                    h = (this.options[t ? "hide" : "show"], this.options.position),
                    u = this.options.content,
                    d = this.tooltip.css("width"),
                    p = this.tooltip.is(":visible"),
                    f = t || 1 === l.target.length,
                ...
                r.length && (S.each(t, function(t, e) {
                    var i = S.inArray(e, s); - 1 < i && a.push(s.splice(i, 1)[0])
                ...
                return !arguments.length && a || "api" === s ? a : "string" == typeof t ? (this.each(function() {
                    var t = S.data(this, T);
                    if (!t) return k;
                    if (r && r.timeStamp && (t.cache.event = r), !e || "option" !== s && "options" !== s) t[s] && t[s].apply(t, o);
                    else {
                    ...
                    return i = !i || i === A || i.length < 1 || y.api[i] ? y.nextid++ : i, (e = function(t, e, i) {
                        ...
                        if (n.container.length || (n.container = c), n.target === A && (n.target = l), r.show.target === A && (r.show.target = l), r.show.solo === k && (r.show.solo = n.container.closest("body")), r.hide.target === A && (r.hide.target = l), r.position.viewport === k && (r.position.viewport = n.container), n.container = n.container.eq(0), n.at = new b(n.at, k), n.my = new b(n.my), t.data(T))
                            if (r.overwrite) t.qtip("destroy", !0);
                            else if (r.overwrite === A) return A;
            ...
            var Z, tt, et, it, st, nt, ot = "margin",
                rt = "border",
                at = "color",
                ct = "background-color",
                lt = "transparent",
                ht = " !important",
                ut = !!gt.createElement("canvas").getContext,
                dt = /rgba?\(0, 0, 0(, 0)?\)|transparent|#123456/i,
                pt = {},
                ft = ["Webkit", "O", "Moz", "ms"];
            ut ? (tt = mt.devicePixelRatio || 1, et = (nt = gt.createElement("canvas").getContext("2d")).backingStorePixelRatio || nt.webkitBackingStorePixelRatio || nt.mozBackingStorePixelRatio || nt.msBackingStorePixelRatio || nt.oBackingStorePixelRatio || 1, it = tt / et) : st = function(t, e, i) {
                ...
                _calculateSize: function(t) {
                    var e, i, s = t.precedance === E,
                        ...
                        c = Math.pow,
                        l = Math.round,
                        h = Math.sqrt(c(a, 2) + c(o, 2)),
                        u = [this.border / a * h, this.border / o * h];
                ...
                update: function(t, e) {
                    ...
                    var i, s, n, o, r, a, c, l, h = this.qtip.elements,
                        u = this.element,
                        d = u.children(),
                        p = this.options,
                        f = this.size,
                ...
                var a, x, w, T, _, j, q, C, c = e.target,
                    l = t.elements.tooltip,
                    S = e.my,
                    k = e.at,
                    h = e.adjust,
                    u = h.method.split(" "),
